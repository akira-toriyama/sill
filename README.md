...
The table is the theming core; sill also ships CLI / config / logging
helpers + the shared widget kit (`CLIKit`, `ConfigSchema`, `LogKit`,
`ThemeKit`) plus the `prism` dev bench. The full
