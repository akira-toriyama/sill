...
- 現行 **v1.10.0**（#5 完了 = perch PR #133 merged・**sill 変更なし**で perch 色計算を PaletteKit に寄せた／#4 = perch PR #132 merged／#3 = PR #54 tagged 2026-06-20）。**番号が小さいほど先**にやる。
