...
let kitCatalog: [KitComponent] = [
    ...
    KitComponent(
        ...
        variants: [
                 ...
                 "capture seams: previewHighlight/previewSelection/previewScrollY/previewScrollX + previewDragSource/previewDropTarget (id-keyed, deterministic prism shots — the live ghost is a child window, hand-checked)",
