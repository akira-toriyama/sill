...
let kitCatalog: [KitComponent] = [
    ...
    KitComponent(
        ...
        keyAPI: [
                 ...
                 "onActivate: ((ThemeKit.ListItem)->Void)? — click/Enter on a row (host's 実処理)",
