...
let kitCatalog: [KitComponent] = [
    ...
    KitComponent(
        ...
        keyAPI: [
                 "items: [ListItem] — rows (id, image: pre-resolved NSImage?, primary/secondary text, badges: [Badge], trailing: TrailingAccessory, tint: ListTint, kind: .row/.sectionHeader/.separator, isDisabled, axChecked); assign relayouts+repaints",
